  ...
  Widget build(BuildContext context) {
    ...
    child: appBarAtivo == true && _selectedIndex == appBarPagina
      ...
      bottomNavigationBar:BottomNavigationBar(
        ...
        unselectedItemColor: corIconenaoselecionado,
      ...
      body: SafeArea(
        child: WebView(
          ...
          userAgent: 'Mozilla/5.0 (Linux; Android 10; SM-G960U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Mobile Safari/537.36',
